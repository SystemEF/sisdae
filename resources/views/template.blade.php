  ...
  @if (Auth::user())
    <div class="wrapper">
      ...
      @elseif (auth()->user()->type =="Profesor")
        @include('modules.menuProfesor')          
      @else
        @include('modules.menuAlumno')          
      @endif
...
<!-- jvectormap -->
{{-- <script src="http://127.0.0.1:8000/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="http://127.0.0.1:8000/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script> --}}
<!-- jQuery Knob Chart -->
...
<!-- Slimscroll -->
<script src="bhttp://127.0.0.1:8000/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
